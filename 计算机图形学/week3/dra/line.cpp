...
vector<point_2V> update_oldPoints(vector<point_2V> face_points, vector<edge> input_edges, vector<point_2V> input_points, vector<face> input_faces)
{
    ...
    for (auto i : input_points)
    {
        ...
        else
        {
            ...
            {
                if (i.degree == 3 && i.p_id > 7 && i.p_id < 45 && i.p_id != 8 &&
                i.p_id != 14 && i.p_id != 15 && i.p_id != 21 && i.p_id != 22 &&
                i.p_id != 30 && i.p_id != 31 && i.p_id != 37 && i.p_id != 38 &&
                i.p_id != 44) // 奇异点
                {
                point_2V temp;
                // 获取5个边中心点
...
{
    cout << "---------" << endl;
    cout << "line between edge_points and old_points" << endl;
...
int main()
{
    ...
    vector<edge> e;     // 存储边
    vector<face> f;     // 存储面
    string filename = "/home/cs18/Desktop/dra/result.obj";
